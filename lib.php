...
class plagiarism_plugin_moss extends plagiarism_plugin {
    ...
    public function get_links($linkarray) {
        ...
        //else{
            //add online
            $text2 = get_string('searchonline','plagiarism_moss');
            $params2 = array('id' => $linkarray['cmid'], 'user' => $linkarray['userid']);
            $url2 = new moodle_url('/plagiarism/moss/online.php', $params2);
            $title2 = get_string('searchonline', 'plagiarism_moss');
            $link .= html_writer::link($url2, $text2, array('title' => $title2));
        //}
        return $link;
    }
